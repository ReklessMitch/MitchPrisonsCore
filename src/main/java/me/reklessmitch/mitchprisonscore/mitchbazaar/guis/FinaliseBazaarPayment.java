...
public class FinaliseBazaarPayment extends ChestGui {
    ...
    private final Currency currencyToBeBrought;
    private final Currency currencyToBuyWith;
    private Map<ShopValue, Long> cheapestItems = new HashMap<>();
    private final Player player;


    public FinaliseBazaarPayment(Player player, BigInteger amount, Currency currencyToBeBrought, Currency currencyToBuyWith) {
        this.player = player;
    ...
    private BigInteger getCost(){
        ...
        List<ShopValue> shopPrices = BazaarConf.get().getSellPrices().get(currencyToBeBrought).get(currencyToBuyWith);
